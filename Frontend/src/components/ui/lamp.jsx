  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-slate-950/60 blur-2xl"></div>
        <div className="absolute top-1/2 z-50 h-48 w-full bg-transparent opacity-10 backdrop-blur-md"></div>
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-cyan-500 opacity-50 blur-[80px]"></div>
        <motion.div
          initial={{ width: "8rem" }}
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[5rem] md:-translate-y-[6rem] bg-cyan-400"
        ></motion.div>
      </div>

      <div className="relative z-50 flex flex-col items-center px-5 pt-16 md:pt-24 -translate-y-8 md:-translate-y-12">
        {children}
      </div>
    </div>
  );
