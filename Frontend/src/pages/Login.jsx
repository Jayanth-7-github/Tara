...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex items-center justify-center px-4 font-sans">
      <div className="w-full max-w-md bg-gray-900 border border-gray-800 rounded-2xl p-8 sm:p-10 shadow-xl">
        <div className="mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6" noValidate>
          <div className="space-y-2">
            <label className="text-sm font-medium text-gray-300" htmlFor="emailOrRegno">
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link to="/signup" className="text-blue-500 hover:text-blue-400 font-bold">
              Create Account
            </Link>
          </div>
        </div>
